...
<br>
```{r, out.width = "250px", out.extra='style="background-color: #FFFFFF; padding:10px; display: inline-block;"'}
# http://zevross.com/blog/2017/06/19/tips-and-tricks-for-working-with-images-and-figures-in-r-markdown-documents/
logos<-list.files("logos", pattern = ".jpeg", full.names = TRUE)
knitr::include_graphics(logos)
```

<br>
```{r, out.width = "150px", out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(logos[1])
```
<br>
...
```{r out.width = "150px", out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(logos[2])
```
<br>
...
```{r, out.width = "150px", out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(logos[3])
```
<br>
...
```{r, out.width = "150px", out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(logos[5])
```
<br>
...
```{r, out.width = "150px", out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(logos[6])
```
<br>
